...
- No functional changes, only clarifications and chore changes
...
- Initial release (as part of the STAC API repository)

[Unreleased]: <https://github.com/stac-api-extensions/browseable/compare/v1.0.0-rc.3...main>
